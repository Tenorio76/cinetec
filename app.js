...
for(var i=0; i < botonesEliminarItem.length;i++){
    ...
    button.addEventListener('click',elimminarItemCarrito);}
    //sumar
...
function elimminarItemCarrito(event){
...
<div class="carrito-item-detalles"></div>
...
item.getElementsByClassName('btn-eliminar')[0].addEventListener('click',elimminarItemCarrito);
